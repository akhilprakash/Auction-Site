...
urlpatterns = patterns('',
    ...
    url(r'^confirm-registration/(?P<username>.+)/(?P<token>[a-z0-9\-]+)$', 'auction.views.confirmRegistration', name='confirm'),
    ...
    url(r'^confirmPasswordReset/(?P<username>.+)/(?P<token>[a-z0-9\-]+)$', 'auction.views.confirmPasswordReset', name='confirmPass'),
    ...
    url(r'^sendEmail/(?P<sellerId>\d+)/(?P<itemTitle>.+)$', 'auction.views.sendEmail', name='sendEmail'),
